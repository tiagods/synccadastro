...
import com.prolink.sync.factory.ConnectionFactory;
		...
		while(linha.hasNext()){
			...
			while(columns.hasNext()){
				...
				if(row.getRowNum()!=0 && celula.getColumnIndex()==0){
					try{
						Integer.parseInt(readingCell(celula).trim());//se n�o conseguir o cast, o campo codigo estara em branco, nesse caso o for ira fechar
