...
public class ClienteComentario implements Serializable {
	...
	/**
	 * @param cOMPL_STS the cOMPL_STS to set
	 */
	...
	/**
	 * @param qUANT_SOC_GER the qUANT_SOC_GER to set
	 */
	...
	/**
	 * @param dATA_CNPJ the dATA_CNPJ to set
	 */
	...
	/**
	 * @param vLR_CAPITAL the vLR_CAPITAL to set
	 */
	...
	/**
	 * @param vL_EXTENSO the vL_EXTENSO to set
	 */
	...
	/**
	 * @param vL_COTA the vL_COTA to set
	 */
	...
	/**
	 * @param vL_EXT_COTA the vL_EXT_COTA to set
	 */
	...
	/**
	 * @param cOTAS_TOTAL the cOTAS_TOTAL to set
	 */
	...
	/**
	 * @param cOTAS_EXTENSO the cOTAS_EXTENSO to set
	 */
	...
	/**
	 * @param pERC_CAP_1 the pERC_CAP_1 to set
	 */
	...
	/**
	 * @param pERC_CAP_2 the pERC_CAP_2 to set
	 */
	...
	/**
	 * @param pERC_CAP_DEMAIS the pERC_CAP_DEMAIS to set
	 */
	...
	/**
	 * @param sOMA_PERC_CAP the sOMA_PERC_CAP to set
	 */
	...
	/**
	 * @param cOTAS_01 the cOTAS_01 to set
	 */
	...
	/**
	 * @param cOTAS_02 the cOTAS_02 to set
	 */
	...
	/**
	 * @param dATA_IM the dATA_IM to set
	 */
	...
	/**
	 * @param aLIQUOTA_DE_ISS the aLIQUOTA_DE_ISS to set
	 */
	...
	/**
	 * @param eNC_MUNIC the eNC_MUNIC to set
	 */
	...
	/**
	 * @param dT_DISTRATO the dT_DISTRATO to set
	 */
	...
	/**
	 * @param n_REG_CART_OU_NIRE the n_REG_CART_OU_NIRE to set
	 */
	...
	/**
	 * @param dATA_REG_CART_OU_JUCESP the dATA_REG_CART_OU_JUCESP to set
	 */
	...
	/**
	 * @param sIND_CNPJ the sIND_CNPJ to set
	 */
	...
	/**
	 * @param cOMP_CNAE1 the cOMP_CNAE1 to set
	 */
	...
	/**
	 * @param dIG_CNAE1 the dIG_CNAE1 to set
	 */
	...
	/**
	 * @param cOMP_CNAE the cOMP_CNAE to set
	 */
	...
	/**
	 * @param dIG_CNAE the dIG_CNAE to set
	 */
	...
	/**
	 * @param qUANT_SOCIOS the qUANT_SOCIOS to set
	 */
	...
	/**
	 * @param iNDICADO the iNDICADO to set
	 */
	...
	/**
	 * @param aPELIDO_1 the aPELIDO_1 to set
	 */
	...
	/**
	 * @param eND_CORRESP the eND_CORRESP to set
	 */
	...
	/**
	 * @param bAIRRO_CO the bAIRRO_CO to set
	 */
	...
	/**
	 * @param cID_CO the cID_CO to set
	 */
	...
	/**
	 * @param eST_CO the eST_CO to set
	 */
	...
	/**
	 * @param cEP_CO the cEP_CO to set
	 */
	...
	/**
	 * @param nOME_SOCIO1 the nOME_SOCIO1 to set
	 */
	...
	/**
	 * @param qUALIDADE1 the qUALIDADE1 to set
	 */
	...
	/**
	 * @param nAC_01 the nAC_01 to set
	 */
	...
	/**
	 * @param nATURALIDADE_1 the nATURALIDADE_1 to set
	 */
	...
	/**
	 * @param eST_CIVEL_01 the eST_CIVEL_01 to set
	 */
	...
	/**
	 * @param mAIOR_EMANCIPADO_1 the mAIOR_EMANCIPADO_1 to set
	 */
	...
	/**
	 * @param pROF_01 the pROF_01 to set
	 */
	...
	/**
	 * @param dIA_NASC1 the dIA_NASC1 to set
	 */
	...
	/**
	 * @param mES_NASC1 the mES_NASC1 to set
	 */
	...
	/**
	 * @param aNO_NASC1 the aNO_NASC1 to set
	 */
	...
	/**
	 * @param pIS_SOC1 the pIS_SOC1 to set
	 */
	...
	/**
	 * @param eND_SOC_1 the eND_SOC_1 to set
	 */
	...
	/**
	 * @param bAIRRO1 the bAIRRO1 to set
	 */
	...
	/**
	 * @param oRGAO1 the oRGAO1 to set
	 */
	...
	/**
	 * @param dATA_EXP1 the dATA_EXP1 to set
	 */
	...
	/**
	 * @param eMAIL_SOC_1 the eMAIL_SOC_1 to set
	 */
	...
	/**
	 * @param eMAIL_FINANCEIRO the eMAIL_FINANCEIRO to set
	 */
	...
	/**
	 * @param fONERES1 the fONERES1 to set
	 */
	...
	/**
	 * @param rES_RAMAL_1 the rES_RAMAL_1 to set
	 */
	...
	/**
	 * @param dDD1COML the dDD1COML to set
	 */
	...
	/**
	 * @param fONECOML1 the fONECOML1 to set
	 */
	...
	/**
	 * @param cOML_RAMAL_1 the cOML_RAMAL_1 to set
	 */
	...
	/**
	 * @param dDD1CEL the dDD1CEL to set
	 */
	...
	/**
	 * @param dDD1REC the dDD1REC to set
	 */
	...
	/**
	 * @param fONEREC1 the fONEREC1 to set
	 */
	...
	/**
	 * @param oBSFONE_REC1 the oBSFONE_REC1 to set
	 */
	...
	/**
	 * @param nOME_SOC_2 the nOME_SOC_2 to set
	 */
	...
	/**
	 * @param qUALIDADE2 the qUALIDADE2 to set
	 */
	...
	/**
	 * @param nAC_02 the nAC_02 to set
	 */
	...
	/**
	 * @param nATURALIDADE_2 the nATURALIDADE_2 to set
	 */
	...
	/**
	 * @param eST_CIVEL_02 the eST_CIVEL_02 to set
	 */
	...
	/**
	 * @param mAIOR_EMANCIPADO_2 the mAIOR_EMANCIPADO_2 to set
	 */
	...
	/**
	 * @param pROF_02 the pROF_02 to set
	 */
	...
	/**
	 * @param eND_SOC_2 the eND_SOC_2 to set
	 */
	...
	/**
	 * @param dIA_NASC2 the dIA_NASC2 to set
	 */
	...
	/**
	 * @param mES_NASC2 the mES_NASC2 to set
	 */
	...
	/**
	 * @param aNO_NASC2 the aNO_NASC2 to set
	 */
	...
	/**
	 * @param pIS_SOC2 the pIS_SOC2 to set
	 */
	...
	/**
	 * @param oRGAO2 the oRGAO2 to set
	 */
	...
	/**
	 * @param dATA_EXP2 the dATA_EXP2 to set
	 */
	...
	/**
	 * @param dDD2RES the dDD2RES to set
	 */
	...
	/**
	 * @param fONERES2 the fONERES2 to set
	 */
	...
	/**
	 * @param dDD2COML the dDD2COML to set
	 */
	...
	/**
	 * @param fONECOM2 the fONECOM2 to set
	 */
	...
	/**
	 * @param dDD2CEL the dDD2CEL to set
	 */
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ClienteComentario other = (ClienteComentario) obj;
		if (ID != other.ID)
			return false;
		return true;
	}
